...
class batting1 extends StatefulWidget {
  final date;
  final match;
  //final inning;
   batting1({super.key,required this.date,required this.match,});

  @override
  State<batting1> createState() => _batting1State(Date: date, Match: match,);
}

class _batting1State extends State<batting1> {
  final String Date;
  final String Match;
  //final String Inning;
  _batting1State({required this.Date,required this.Match,});
  @override
          ...
          children:[
            ...
            Container(margin: const EdgeInsets.only(top: 70,),
              child:StreamBuilder<QuerySnapshot>(
                ...
                doc(Match).collection('innings').doc('inning1').collection('performance').doc('batting').collection('players').snapshots(),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  //VerticalDivider(color: Col5rs.red,thickness: 5,),
                                  ...
                                  //Container(height: 20,width: 70,child: Center(child: Text(petDocs[index]['sixes']))),
                                ],
                              ),
                              SizedBox(height: 10,)
