...
class balling2 extends StatefulWidget {
  final date;
  final match;
  //final inning;
  balling2({super.key,required this.date,required this.match,});

  @override
  State<balling2> createState() => _balling2State(Date: date, Match: match);
}

class _balling2State extends State<balling2> {
  final String Date;
  final String Match;
//  final String Inning;
  _balling2State({required this.Date,required this.Match,});
  @override
          ...
          children:[
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(height: 20,width: 80,child: Center(child: Text("Name",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)))),
            ...
            Container(margin: const EdgeInsets.only(top: 70),
              child:StreamBuilder<QuerySnapshot>(
                ...
                doc(Match).collection('innings').doc('inning2').collection('performance').doc('balling').collection('players').snapshots(),
                          ...
                          Column(
                            children: [
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  Container(height: 20,width: 70,child: Center(child: Text(petDocs[index]['name'],style: TextStyle(color: Color(0xff05fc79))))),
